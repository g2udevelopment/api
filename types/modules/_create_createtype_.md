...
*Defined in [packages/types/src/create/createType.ts:76](https://github.com/polkadot-js/api/blob/dde7c8085a/packages/types/src/create/createType.ts#L76)*
...
*Defined in [packages/types/src/create/createType.ts:60](https://github.com/polkadot-js/api/blob/dde7c8085a/packages/types/src/create/createType.ts#L60)*
