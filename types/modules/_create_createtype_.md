...
*Defined in [packages/types/src/create/createType.ts:77](https://github.com/polkadot-js/api/blob/938ace2342/packages/types/src/create/createType.ts#L77)*
...
*Defined in [packages/types/src/create/createType.ts:61](https://github.com/polkadot-js/api/blob/938ace2342/packages/types/src/create/createType.ts#L61)*
