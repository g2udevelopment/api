...
*Defined in [api/src/types/storage.ts:42](https://github.com/polkadot-js/api/blob/938ace2342/packages/api/src/types/storage.ts#L42)*
...
*Defined in [api/src/types/storage.ts:43](https://github.com/polkadot-js/api/blob/938ace2342/packages/api/src/types/storage.ts#L43)*
