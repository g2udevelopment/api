...
*Defined in [api/src/types/storage.ts:31](https://github.com/polkadot-js/api/blob/50b8db2263/packages/api/src/types/storage.ts#L31)*
...
*Defined in [api/src/types/storage.ts:34](https://github.com/polkadot-js/api/blob/50b8db2263/packages/api/src/types/storage.ts#L34)*
