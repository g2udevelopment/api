...
*Defined in [api/src/types/storage.ts:31](https://github.com/polkadot-js/api/blob/dde7c8085a/packages/api/src/types/storage.ts#L31)*
...
*Defined in [api/src/types/storage.ts:34](https://github.com/polkadot-js/api/blob/dde7c8085a/packages/api/src/types/storage.ts#L34)*
