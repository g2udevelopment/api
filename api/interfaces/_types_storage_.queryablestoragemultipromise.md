...
*Defined in [api/src/types/storage.ts:74](https://github.com/polkadot-js/api/blob/0e18fdbccc/packages/api/src/types/storage.ts#L74)*
...
*Defined in [api/src/types/storage.ts:75](https://github.com/polkadot-js/api/blob/0e18fdbccc/packages/api/src/types/storage.ts#L75)*
