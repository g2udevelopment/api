...
*Defined in [api/src/types/storage.ts:75](https://github.com/polkadot-js/api/blob/6e83e6aaef/packages/api/src/types/storage.ts#L75)*
...
*Defined in [api/src/types/storage.ts:76](https://github.com/polkadot-js/api/blob/6e83e6aaef/packages/api/src/types/storage.ts#L76)*
