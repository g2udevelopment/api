...
*Defined in [api/src/types/storage.ts:75](https://github.com/polkadot-js/api/blob/7ed958fb2d/packages/api/src/types/storage.ts#L75)*
...
*Defined in [api/src/types/storage.ts:76](https://github.com/polkadot-js/api/blob/7ed958fb2d/packages/api/src/types/storage.ts#L76)*
