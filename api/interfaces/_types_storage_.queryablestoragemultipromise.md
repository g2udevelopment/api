...
*Defined in [api/src/types/storage.ts:74](https://github.com/polkadot-js/api/blob/acdf27a272/packages/api/src/types/storage.ts#L74)*
...
*Defined in [api/src/types/storage.ts:75](https://github.com/polkadot-js/api/blob/acdf27a272/packages/api/src/types/storage.ts#L75)*
