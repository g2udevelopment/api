...
*Defined in [api/src/promise/Combinator.ts:29](https://github.com/polkadot-js/api/blob/28aa9e18a7/packages/api/src/promise/Combinator.ts#L29)*
...
*Defined in [api/src/promise/Combinator.ts:79](https://github.com/polkadot-js/api/blob/28aa9e18a7/packages/api/src/promise/Combinator.ts#L79)*
