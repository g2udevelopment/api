...
*Defined in [api/src/promise/Combinator.ts:29](https://github.com/polkadot-js/api/blob/47fc4a2b3c/packages/api/src/promise/Combinator.ts#L29)*
...
*Defined in [api/src/promise/Combinator.ts:79](https://github.com/polkadot-js/api/blob/47fc4a2b3c/packages/api/src/promise/Combinator.ts#L79)*
