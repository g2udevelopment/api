...
*Defined in [api/src/promise/Combinator.ts:29](https://github.com/polkadot-js/api/blob/dde7c8085a/packages/api/src/promise/Combinator.ts#L29)*
...
*Defined in [api/src/promise/Combinator.ts:77](https://github.com/polkadot-js/api/blob/dde7c8085a/packages/api/src/promise/Combinator.ts#L77)*
