...
*Defined in [api/src/promise/Combinator.ts:29](https://github.com/polkadot-js/api/blob/50b8db2263/packages/api/src/promise/Combinator.ts#L29)*
...
*Defined in [api/src/promise/Combinator.ts:79](https://github.com/polkadot-js/api/blob/50b8db2263/packages/api/src/promise/Combinator.ts#L79)*
