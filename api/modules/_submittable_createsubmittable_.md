...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/5bfc2cd534/packages/api/src/submittable/createSubmittable.ts#L17)*
