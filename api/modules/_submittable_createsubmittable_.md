...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/dde7c8085a/packages/api/src/submittable/createSubmittable.ts#L17)*
