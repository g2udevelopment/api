...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/938ace2342/packages/api/src/submittable/createSubmittable.ts#L17)*
