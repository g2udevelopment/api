...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/337de79bef/packages/api/src/submittable/createSubmittable.ts#L17)*
