...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/7ed958fb2d/packages/api-derive/src/session/sessionProgress.ts#L13)*
