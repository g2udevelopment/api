...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/50b8db2263/packages/api-derive/src/session/sessionProgress.ts#L13)*
