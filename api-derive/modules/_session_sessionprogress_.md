...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/dac1df35de/packages/api-derive/src/session/sessionProgress.ts#L13)*
