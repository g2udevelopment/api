...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/66d1bbe4cb/packages/api-derive/src/session/sessionProgress.ts#L13)*
