...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/6f2d62bb3b/packages/api-derive/src/session/sessionProgress.ts#L13)*
