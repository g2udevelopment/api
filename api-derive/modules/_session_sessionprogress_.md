...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/a2f179acb1/packages/api-derive/src/session/sessionProgress.ts#L13)*
