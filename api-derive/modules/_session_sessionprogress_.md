...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/28aa9e18a7/packages/api-derive/src/session/sessionProgress.ts#L13)*
