...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/f825c7f187/packages/api-derive/src/session/sessionProgress.ts#L13)*
