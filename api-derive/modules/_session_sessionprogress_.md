...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/acdf27a272/packages/api-derive/src/session/sessionProgress.ts#L13)*
