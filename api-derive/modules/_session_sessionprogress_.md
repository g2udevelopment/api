...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/f8d4fcaf04/packages/api-derive/src/session/sessionProgress.ts#L13)*
