...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/6e83e6aaef/packages/api-derive/src/session/sessionProgress.ts#L13)*
