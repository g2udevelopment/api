...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/ea0e5e4547/packages/api-derive/src/session/sessionProgress.ts#L13)*
