...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/45786b31da/packages/api-derive/src/session/sessionProgress.ts#L13)*
