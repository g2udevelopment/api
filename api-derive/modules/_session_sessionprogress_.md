...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/6727e12468/packages/api-derive/src/session/sessionProgress.ts#L13)*
