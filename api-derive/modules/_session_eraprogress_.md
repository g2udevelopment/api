...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/4aa66fd4c6/packages/api-derive/src/session/eraProgress.ts#L13)*
