...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/66d1bbe4cb/packages/api-derive/src/session/eraProgress.ts#L13)*
