...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/50b8db2263/packages/api-derive/src/session/eraProgress.ts#L13)*
