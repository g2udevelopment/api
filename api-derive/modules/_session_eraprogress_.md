...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/c9921f002f/packages/api-derive/src/session/eraProgress.ts#L13)*
