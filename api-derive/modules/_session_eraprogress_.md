...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/5bfc2cd534/packages/api-derive/src/session/eraProgress.ts#L13)*
