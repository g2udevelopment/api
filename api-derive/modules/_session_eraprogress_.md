...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/14874f41f7/packages/api-derive/src/session/eraProgress.ts#L13)*
