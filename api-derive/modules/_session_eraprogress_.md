...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/fe69f70539/packages/api-derive/src/session/eraProgress.ts#L13)*
