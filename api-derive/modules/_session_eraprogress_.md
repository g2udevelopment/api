...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/7ed958fb2d/packages/api-derive/src/session/eraProgress.ts#L13)*
