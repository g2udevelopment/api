...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/e3abb95111/packages/api-derive/src/session/eraProgress.ts#L13)*
