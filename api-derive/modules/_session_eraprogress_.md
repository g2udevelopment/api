...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/a2f179acb1/packages/api-derive/src/session/eraProgress.ts#L13)*
