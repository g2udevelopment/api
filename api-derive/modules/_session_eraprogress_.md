...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/dac1df35de/packages/api-derive/src/session/eraProgress.ts#L13)*
