...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/4bd2f2fc32/packages/api-derive/src/session/eraProgress.ts#L13)*
