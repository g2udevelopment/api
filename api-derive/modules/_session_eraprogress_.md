...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/ea0e5e4547/packages/api-derive/src/session/eraProgress.ts#L13)*
