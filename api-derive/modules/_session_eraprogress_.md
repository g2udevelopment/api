...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/c5c77c9b52/packages/api-derive/src/session/eraProgress.ts#L13)*
