...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/2b9152871e/packages/api-derive/src/session/eraProgress.ts#L13)*
