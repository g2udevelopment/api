...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/6f2d62bb3b/packages/api-derive/src/session/eraProgress.ts#L13)*
