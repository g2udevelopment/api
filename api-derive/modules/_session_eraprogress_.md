...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/dde7c8085a/packages/api-derive/src/session/eraProgress.ts#L13)*
