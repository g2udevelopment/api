...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/b0dc7cf451/packages/api-derive/src/session/eraProgress.ts#L13)*
