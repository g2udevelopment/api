...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/e8b127e177/packages/api-derive/src/session/eraProgress.ts#L13)*
