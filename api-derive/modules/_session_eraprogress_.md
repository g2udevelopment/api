...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/c0e3026772/packages/api-derive/src/session/eraProgress.ts#L13)*
