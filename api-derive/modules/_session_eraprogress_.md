...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/97438bb2e8/packages/api-derive/src/session/eraProgress.ts#L13)*
