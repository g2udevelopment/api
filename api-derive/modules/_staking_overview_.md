...
*Defined in [packages/api-derive/src/staking/overview.ts:16](https://github.com/polkadot-js/api/blob/938ace2342/packages/api-derive/src/staking/overview.ts#L16)*
