...
*Defined in [packages/api-derive/src/staking/overview.ts:16](https://github.com/polkadot-js/api/blob/393f46ba4a/packages/api-derive/src/staking/overview.ts#L16)*
