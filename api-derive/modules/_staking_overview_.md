...
*Defined in [packages/api-derive/src/staking/overview.ts:16](https://github.com/polkadot-js/api/blob/dde7c8085a/packages/api-derive/src/staking/overview.ts#L16)*
