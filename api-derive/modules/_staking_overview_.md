...
*Defined in [packages/api-derive/src/staking/overview.ts:16](https://github.com/polkadot-js/api/blob/0e18fdbccc/packages/api-derive/src/staking/overview.ts#L16)*
