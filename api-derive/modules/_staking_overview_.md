...
*Defined in [packages/api-derive/src/staking/overview.ts:16](https://github.com/polkadot-js/api/blob/67a3376ef8/packages/api-derive/src/staking/overview.ts#L16)*
