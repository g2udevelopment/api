...
*Defined in [packages/api-derive/src/staking/overview.ts:16](https://github.com/polkadot-js/api/blob/7ed958fb2d/packages/api-derive/src/staking/overview.ts#L16)*
