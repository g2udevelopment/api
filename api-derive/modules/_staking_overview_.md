...
*Defined in [packages/api-derive/src/staking/overview.ts:16](https://github.com/polkadot-js/api/blob/337de79bef/packages/api-derive/src/staking/overview.ts#L16)*
