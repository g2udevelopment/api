...
*Defined in [packages/api-derive/src/staking/overview.ts:16](https://github.com/polkadot-js/api/blob/b174864804/packages/api-derive/src/staking/overview.ts#L16)*
