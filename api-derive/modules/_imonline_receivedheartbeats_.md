...
*Defined in [packages/api-derive/src/imOnline/receivedHeartbeats.ts:18](https://github.com/polkadot-js/api/blob/938ace2342/packages/api-derive/src/imOnline/receivedHeartbeats.ts#L18)*
