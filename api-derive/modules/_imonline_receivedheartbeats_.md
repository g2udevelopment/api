...
*Defined in [packages/api-derive/src/imOnline/receivedHeartbeats.ts:18](https://github.com/polkadot-js/api/blob/393f46ba4a/packages/api-derive/src/imOnline/receivedHeartbeats.ts#L18)*
