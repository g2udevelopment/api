...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/c9921f002f/packages/api-derive/src/session/eraLength.ts#L13)*
