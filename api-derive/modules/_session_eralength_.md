...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/e3abb95111/packages/api-derive/src/session/eraLength.ts#L13)*
