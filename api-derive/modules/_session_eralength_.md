...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/44cdf49b2c/packages/api-derive/src/session/eraLength.ts#L13)*
