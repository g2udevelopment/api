...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/b0dc7cf451/packages/api-derive/src/session/eraLength.ts#L13)*
