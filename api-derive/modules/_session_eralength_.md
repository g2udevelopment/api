...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/0cf29719b3/packages/api-derive/src/session/eraLength.ts#L13)*
