...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/b174864804/packages/api-derive/src/session/eraLength.ts#L13)*
