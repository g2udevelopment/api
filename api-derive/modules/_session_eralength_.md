...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/a2f179acb1/packages/api-derive/src/session/eraLength.ts#L13)*
