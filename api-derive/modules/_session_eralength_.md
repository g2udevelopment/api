...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/393f46ba4a/packages/api-derive/src/session/eraLength.ts#L13)*
