...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/f8f7e92da4/packages/api-derive/src/session/eraLength.ts#L13)*
