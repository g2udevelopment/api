...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/47fc4a2b3c/packages/api-derive/src/session/eraLength.ts#L13)*
