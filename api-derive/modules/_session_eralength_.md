...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/14874f41f7/packages/api-derive/src/session/eraLength.ts#L13)*
