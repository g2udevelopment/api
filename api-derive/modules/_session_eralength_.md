...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/66aa38000b/packages/api-derive/src/session/eraLength.ts#L13)*
