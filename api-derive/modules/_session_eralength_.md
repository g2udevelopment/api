...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/dde7c8085a/packages/api-derive/src/session/eraLength.ts#L13)*
