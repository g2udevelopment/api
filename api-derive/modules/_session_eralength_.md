...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/0c5b69bea1/packages/api-derive/src/session/eraLength.ts#L13)*
