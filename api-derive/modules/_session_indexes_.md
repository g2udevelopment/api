...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/0cf29719b3/packages/api-derive/src/session/indexes.ts#L78)*
