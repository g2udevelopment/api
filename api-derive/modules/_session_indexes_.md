...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/c5c77c9b52/packages/api-derive/src/session/indexes.ts#L78)*
