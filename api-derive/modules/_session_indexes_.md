...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/0c5b69bea1/packages/api-derive/src/session/indexes.ts#L78)*
