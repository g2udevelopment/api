...
*Defined in [packages/api-derive/src/session/indexes.ts:79](https://github.com/polkadot-js/api/blob/e8b127e177/packages/api-derive/src/session/indexes.ts#L79)*
