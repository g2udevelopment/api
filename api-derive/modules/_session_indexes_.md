...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/c9921f002f/packages/api-derive/src/session/indexes.ts#L78)*
