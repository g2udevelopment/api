...
*Defined in [packages/api-derive/src/staking/erasPrefs.ts:27](https://github.com/polkadot-js/api/blob/5bfc2cd534/packages/api-derive/src/staking/erasPrefs.ts#L27)*
...
*Defined in [packages/api-derive/src/staking/erasPrefs.ts:54](https://github.com/polkadot-js/api/blob/5bfc2cd534/packages/api-derive/src/staking/erasPrefs.ts#L54)*
...
*Defined in [packages/api-derive/src/staking/erasPrefs.ts:48](https://github.com/polkadot-js/api/blob/5bfc2cd534/packages/api-derive/src/staking/erasPrefs.ts#L48)*
...
*Defined in [packages/api-derive/src/staking/erasPrefs.ts:62](https://github.com/polkadot-js/api/blob/5bfc2cd534/packages/api-derive/src/staking/erasPrefs.ts#L62)*
