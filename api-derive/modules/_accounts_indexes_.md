...
*Defined in [packages/api-derive/src/accounts/indexes.ts:72](https://github.com/polkadot-js/api/blob/66d1bbe4cb/packages/api-derive/src/accounts/indexes.ts#L72)*
