...
*Defined in [packages/api-derive/src/accounts/indexes.ts:73](https://github.com/polkadot-js/api/blob/393f46ba4a/packages/api-derive/src/accounts/indexes.ts#L73)*
