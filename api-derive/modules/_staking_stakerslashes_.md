...
*Defined in [packages/api-derive/src/staking/stakerSlashes.ts:14](https://github.com/polkadot-js/api/blob/7ed958fb2d/packages/api-derive/src/staking/stakerSlashes.ts#L14)*
...
*Defined in [packages/api-derive/src/staking/stakerSlashes.ts:29](https://github.com/polkadot-js/api/blob/7ed958fb2d/packages/api-derive/src/staking/stakerSlashes.ts#L29)*
