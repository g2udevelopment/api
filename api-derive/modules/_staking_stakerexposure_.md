...
*Defined in [packages/api-derive/src/staking/stakerExposure.ts:14](https://github.com/polkadot-js/api/blob/7ed958fb2d/packages/api-derive/src/staking/stakerExposure.ts#L14)*
...
*Defined in [packages/api-derive/src/staking/stakerExposure.ts:40](https://github.com/polkadot-js/api/blob/7ed958fb2d/packages/api-derive/src/staking/stakerExposure.ts#L40)*
