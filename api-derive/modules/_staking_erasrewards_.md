...
*Defined in [packages/api-derive/src/staking/erasRewards.ts:24](https://github.com/polkadot-js/api/blob/7ed958fb2d/packages/api-derive/src/staking/erasRewards.ts#L24)*
...
*Defined in [packages/api-derive/src/staking/erasRewards.ts:56](https://github.com/polkadot-js/api/blob/7ed958fb2d/packages/api-derive/src/staking/erasRewards.ts#L56)*
