...
*Defined in [packages/api-derive/src/staking/erasExposure.ts:45](https://github.com/polkadot-js/api/blob/dac1df35de/packages/api-derive/src/staking/erasExposure.ts#L45)*
...
*Defined in [packages/api-derive/src/staking/erasExposure.ts:37](https://github.com/polkadot-js/api/blob/dac1df35de/packages/api-derive/src/staking/erasExposure.ts#L37)*
...
*Defined in [packages/api-derive/src/staking/erasExposure.ts:53](https://github.com/polkadot-js/api/blob/dac1df35de/packages/api-derive/src/staking/erasExposure.ts#L53)*
