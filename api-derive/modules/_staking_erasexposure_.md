...
*Defined in [packages/api-derive/src/staking/erasExposure.ts:39](https://github.com/polkadot-js/api/blob/5bfc2cd534/packages/api-derive/src/staking/erasExposure.ts#L39)*
...
*Defined in [packages/api-derive/src/staking/erasExposure.ts:66](https://github.com/polkadot-js/api/blob/5bfc2cd534/packages/api-derive/src/staking/erasExposure.ts#L66)*
...
*Defined in [packages/api-derive/src/staking/erasExposure.ts:60](https://github.com/polkadot-js/api/blob/5bfc2cd534/packages/api-derive/src/staking/erasExposure.ts#L60)*
...
*Defined in [packages/api-derive/src/staking/erasExposure.ts:74](https://github.com/polkadot-js/api/blob/5bfc2cd534/packages/api-derive/src/staking/erasExposure.ts#L74)*
