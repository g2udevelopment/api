...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/c0e3026772/packages/api-derive/src/chain/bestNumber.ts#L25)*
