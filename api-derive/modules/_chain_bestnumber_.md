...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/f145488314/packages/api-derive/src/chain/bestNumber.ts#L25)*
