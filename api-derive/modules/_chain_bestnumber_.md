...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/5bfc2cd534/packages/api-derive/src/chain/bestNumber.ts#L25)*
