...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/50b8db2263/packages/api-derive/src/chain/bestNumber.ts#L25)*
