...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/dde7c8085a/packages/api-derive/src/chain/getHeader.ts#L27)*
