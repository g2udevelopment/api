...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/66aa38000b/packages/api-derive/src/chain/getHeader.ts#L27)*
