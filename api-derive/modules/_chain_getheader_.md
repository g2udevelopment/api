...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/5bfc2cd534/packages/api-derive/src/chain/getHeader.ts#L27)*
