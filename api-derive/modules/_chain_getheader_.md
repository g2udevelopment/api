...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/50b8db2263/packages/api-derive/src/chain/getHeader.ts#L27)*
