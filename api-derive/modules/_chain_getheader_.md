...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/393f46ba4a/packages/api-derive/src/chain/getHeader.ts#L27)*
