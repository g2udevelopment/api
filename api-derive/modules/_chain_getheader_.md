...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/7ed958fb2d/packages/api-derive/src/chain/getHeader.ts#L27)*
