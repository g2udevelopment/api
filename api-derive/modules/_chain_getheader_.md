...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/938ace2342/packages/api-derive/src/chain/getHeader.ts#L27)*
