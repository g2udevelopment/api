...
*Defined in [packages/api-derive/src/staking/ownSlashes.ts:13](https://github.com/polkadot-js/api/blob/938ace2342/packages/api-derive/src/staking/ownSlashes.ts#L13)*
