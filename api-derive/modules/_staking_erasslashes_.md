...
*Defined in [packages/api-derive/src/staking/erasSlashes.ts:42](https://github.com/polkadot-js/api/blob/337de79bef/packages/api-derive/src/staking/erasSlashes.ts#L42)*
...
*Defined in [packages/api-derive/src/staking/erasSlashes.ts:31](https://github.com/polkadot-js/api/blob/337de79bef/packages/api-derive/src/staking/erasSlashes.ts#L31)*
...
*Defined in [packages/api-derive/src/staking/erasSlashes.ts:52](https://github.com/polkadot-js/api/blob/337de79bef/packages/api-derive/src/staking/erasSlashes.ts#L52)*
