...
*Defined in [packages/api-derive/src/staking/erasSlashes.ts:33](https://github.com/polkadot-js/api/blob/5bfc2cd534/packages/api-derive/src/staking/erasSlashes.ts#L33)*
...
*Defined in [packages/api-derive/src/staking/erasSlashes.ts:63](https://github.com/polkadot-js/api/blob/5bfc2cd534/packages/api-derive/src/staking/erasSlashes.ts#L63)*
...
*Defined in [packages/api-derive/src/staking/erasSlashes.ts:57](https://github.com/polkadot-js/api/blob/5bfc2cd534/packages/api-derive/src/staking/erasSlashes.ts#L57)*
...
*Defined in [packages/api-derive/src/staking/erasSlashes.ts:73](https://github.com/polkadot-js/api/blob/5bfc2cd534/packages/api-derive/src/staking/erasSlashes.ts#L73)*
